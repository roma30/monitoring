...
$database->query('INSERT INTO statias (categoria, name-categoria, editor1, datareg, lastvisit) VALUES (:categoria, :name-categoria, :editor1, )');

$database->bind(':categoria', $_POST['categoria']);
